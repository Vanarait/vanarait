    ...
    return (
      <div className="chatbot-container">
        <div className={`chatbot-popup ${this.state.isOpen ? 'open' : ''}`}>
          ...
          <a
            href="https://api.whatsapp.com/send?phone=919494494085&amp;text=Hello, I have a question about https%3A%2F%2FvanaraIT.com%2Fonline-training-schedules" // Replace with your WhatsApp number
            target="_blank"
