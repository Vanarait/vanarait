  ...
  return (
    <div className="real-time-project bg-white">
      ...
      <p>
        ...
        for various locations. The application leverages Java for the backend, a
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              Implement Azure App Service for hosting your frontend application
              and backend API.
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul>
            <li>
              Implement user authentication and registration using Azure Active
              Directory (Azure AD) or another authentication service.
            </li>
            <li>
      ...
      <p>
        ...
        and Azure cloud technologies to deliver weather information to users in
        a user-friendly and dynamic manner. It combines backend development,
        frontend design, and cloud-based data management, making it a
        comprehensive and practical project.
      </p>
    </div>
  );
};
